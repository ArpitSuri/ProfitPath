    ...
    return (
        ...
        >
            ...
            <div className="self-start mb-12 md:ml-6 lg:ml-12">
                <span className="px-4 py-1.5 rounded-full  bg-white/5 text-white/70 text-[12px] font-black  tracking-wider">
                    Core Solutions
                </span>
            </div>
            ...
            <div className="text-center mb-24">
                <h2
                    ref={headingRef}
                    className="text-5xl md:text-7xl font-black tracking-wider  leading-[0.9]"
                >
                    Maximize Your <br />
