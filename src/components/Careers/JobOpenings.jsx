...
const JobOpenings = () => {
    ...
    const LINKEDIN_JOBS_URL = "https://www.linkedin.com/company/profitpathgrowth/jobs";
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-0">
                    {jobs.map((job) => (
                        ...
                        >
                            <div>
                                <h3 className="text-xl md:text-2xl font-bold uppercase tracking-tight group-hover:translate-x-2 transition-transform duration-500">
                                    {job.title}
                                </h3>
                                <p className="text-zinc-600 text-xs font-black uppercase tracking-widest mt-2 group-hover:translate-x-2 transition-transform duration-500 delay-75">
                                    {job.location} • {job.type}
                                </p>
                            </div>
