...
export default function Hero() {
    ...
    return (
        <>
            <section className="min-h-screen text-white flex items-center pt-24 pb-12 px-6 md:px-16 overflow-hidden">
                <div
                    ref={heroRef}
                ...
                >
                    ...
                    <div className="flex flex-col gap-6 w-full md:w-1/2 items-center text-center md:items-start md:text-left">
                        ...
                        <div className="flex flex-col sm:flex-row gap-5 w-full sm:w-auto pt-4">
                            ...
                            <button className="group bg-white text-black px-10 py-5 font-questrial rounded-full transition-all duration-300 hover:shadow-[0_0_30px_rgba(255,255,255,0.3)] hover:scale-105 font-bold active:scale-95 cursor-pointer text-sm  tracking-widest flex items-center justify-center gap-2 text-[16px]">
                                Schedule a Call
                            </button>
                    ...
                    <div className="w-full md:w-1/2 flex flex-col sm:flex-row items-center justify-center gap-8 relative">
                        ...
                        <a
                            ...
                            className="flex flex-col items-center gap-4 p-8 rounded-[2rem] transition-all duration-500 group animate-float cursor-pointer"
                        >
                            <div className="h-12 w-32 flex items-center justify-center opacity-80 group-hover:opacity-100 transition-opacity">
                                <img
                                    src="/clutch.svg"
                                    alt="Clutch ogo"
                            ...
                            <div className="flex flex-col items-center gap-2">
                                <div className="flex gap-1">
                                    {[...Array(5)].map((_, i) => (
                                        <svg key={i} viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-white group-hover:scale-110 transition-transform" style={{ transitionDelay: `${i * 50}ms` }}>
                                            <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" />
                                        </svg>
                                    ))}
                                </div>
                                <p className="text-[10px] uppercase tracking-[0.2em] text-white/40 font-bold group-hover:text-white/70 transition-colors">Top Rated Agency</p>
                            </div>
                        </a>
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex flex-col items-center gap-4 p-8 rounded-[2rem] transition-all duration-500 group animate-float-delayed sm:mt-12 cursor-pointer"
                        >
                            <div className="h-12 w-32 flex items-center justify-center opacity-80 group-hover:opacity-100 transition-opacity">
                                {/* Using a secondary badge representation or alternative platform logo */}
                            ...
                            <div className="flex flex-col items-center gap-2">
                                ...
                                <p className="text-[10px] uppercase tracking-[0.2em] text-white/40 font-bold group-hover:text-white/70 transition-colors">Verified Partner</p>
                            </div>
                        </a>

                        {/* Background Glow */}
                        <div className="absolute -z-10 w-64 h-64 bg-emerald-500/10 blur-[120px] rounded-full" />
                    </div>
                </div>
            </section>
        </>
