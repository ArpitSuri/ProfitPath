        ...
        <>
            <section className="min-h-screen text-white flex items-center pt-24 pb-12 px-6 md:px-12 lg:px-16 overflow-hidden">
                ...
                >
                    ...
                    <div className="w-full md:w-2/5 flex flex-row md:flex-col lg:flex-row items-center justify-center gap-3 lg:gap-8 relative">
                        ...
                        <a
                            ...
                            className="flex flex-col items-center gap-2 p-3 lg:p-8 rounded-2xl lg:rounded-[2rem] transition-all duration-500 group animate-float cursor-pointer bg-white/5 border border-white/5 flex-1 md:w-full lg:w-auto"
                        >
                            <div className="h-5 w-12 lg:h-10 lg:w-28 flex items-center justify-center opacity-80 group-hover:opacity-100 transition-opacity">
                                <img
                                    src="/clutch.svg"
                                    alt="Clutch"
                            ...
                            <div className="flex flex-col items-center gap-1">
                                <div className="flex gap-0.5">
                                    {[...Array(5)].map((_, i) => (
                                        <svg key={i} viewBox="0 0 24 24" fill="currentColor" className="w-2 h-2 lg:w-4 lg:h-4 text-white group-hover:scale-110 transition-transform">
                                            <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" />
                                        </svg>
                                    ))}
                                </div>
                                <p className="text-[5px] lg:text-[10px] uppercase tracking-[0.1em] lg:tracking-[0.2em] text-white/40 font-bold whitespace-nowrap">Top Rated</p>
                            </div>
                        </a>
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex flex-col items-center gap-2 p-3 lg:p-8 rounded-2xl lg:rounded-[2rem] transition-all duration-500 group animate-float-delayed lg:mt-12 cursor-pointer bg-white/5 border border-white/5 flex-1 md:w-full lg:w-auto"
                        >
                            <div className="h-5 w-12 lg:h-10 lg:w-28 flex items-center justify-center opacity-80 group-hover:opacity-100 transition-opacity text-sm font-bold tracking-tighter">
                                <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="none" viewBox="0 0 160 31" className="brightness-0 invert">
                            ...
                            <div className="flex flex-col items-center gap-1">
                                ...
                                <p className="text-[5px] lg:text-[10px] uppercase tracking-[0.1em] lg:tracking-[0.2em] text-white/40 font-bold whitespace-nowrap">Verified</p>
                            </div>
                        </a>
                        ...
                        >
                            ...
                            <div className="flex flex-col items-center gap-1">
                                ...
                                <p className="text-[5px] lg:text-[10px] uppercase tracking-[0.1em] lg:tracking-[0.2em] text-white/40 font-bold whitespace-nowrap">5.0 Rating</p>
                            </div>
                        </a>

                        {/* Background Glow */}
                        <div className="absolute -z-10 w-32 h-32 lg:w-64 lg:h-64 bg-emerald-500/10 blur-[60px] lg:blur-[120px] rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
                    </div>
                </div>
            </section>
        </>
