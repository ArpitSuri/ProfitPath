    ...
    return (
        <div className="bg-black  overflow-hidden">
            <div className="max-w-7xl mx-auto px-6  text-left">
                <h2 className="text-white/40 text-sm font-bold tracking-wider  mb-4">
                    We set calls with
                </h2>
            </div>
            ...
            <div className="relative flex items-center">
                ...
                <div className="absolute inset-y-0 left-0 w-[10%] border-r border-r-zinc-700 bg-black z-10"></div>
                ...
                <div className="flex animate-tray-scroll whitespace-nowrap gap-8">
                    {displayLogos.map((name, index) => (
                        <div
                            key={index}
                            className="flex items-center justify-center px-3 py-3 min-w-60 
                         bg-white/5 backdrop-blur-sm border border-white/10 
                         rounded-full transition-all duration-300 
                         hover:bg-white/10 hover:border-white/30 group cursor-pointer"
                        >
                            {/* Logo Placeholder */}
