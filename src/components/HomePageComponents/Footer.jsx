...
const Footer = () => {
    ...
    return (
        <footer className="text-white pt-24 pb-12 px-6 border-t border-white/5">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col lg:flex-row items-center justify-between gap-10 pb-20 border-b border-white/5 mb-20">
                    ...
                    <div className="flex flex-col sm:flex-row w-full lg:w-auto gap-4">
                        <input
                            ...
                            className="bg-white/5 border border-white/10 rounded-full px-8 py-4 w-full lg:w-80 focus:outline-none focus:border-white/30 transition-colors text-sm"
                        />
                        <button className="bg-white text-black px-8 py-4 rounded-full font-bold uppercase text-xs hover:bg-zinc-200 transition-all whitespace-nowrap active:scale-95">
                            Join Now
                        </button>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-16 mb-20">
                    ...
                    <div className="md:col-span-4 flex flex-col items-start gap-8">
                        <div className="flex items-center gap-6">
                            ...
                            <button
                                ...
                                className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center hover:bg-white hover:text-black transition-all group cursor-pointer"
                            >
                                <span className="transform -rotate-45 group-hover:-translate-y-1 transition-transform text-lg">→</span>
                            </button>
                        </div>

                        <p className="text-zinc-500 max-w-xs font-light leading-relaxed text-sm">
                            ProfitPath Growth Partners is a DC-based sales prospecting agency with a global team of over 45 experts. We put sales prospecting and capital raising on <span className="text-zinc-300">auto-pilot</span> through our fully-managed service, delivering opportunities with the likes of BlackRock and Tesla.
                        </p>
                        ...
                        <div className="flex items-center gap-6 pt-2">
                            {/* GoodFirms Logo */}
                            <a
                                href="https://www.goodfirms.co/company/profitpath-growth-partners"
                                target="_blank"
                            ...
                            {/* Clutch Logo */}
                            <a
                                href="https://clutch.co/profile/profitpath-growth-partners"
                                target="_blank"
                                rel="noopener noreferrer"
                            ...
                            >
                                <img
                                    src="/clutch.svg"
                                    alt="Clutch"
                                    className="w-1/2 h-full object-contain brightness-0 invert"
                                />
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="md:col-span-4 flex flex-col gap-8 lg:items-end lg:text-right">
                        <div>
                            ...
                            <p className="text-white font-medium mb-1 text-sm">jesus@profitpathgrowthpartners.com</p>
                            <p className="text-zinc-500 text-xs">8 The Green, STE A, Dover, DE 19901</p>
                        </div>
                        <div>
                            ...
                            <div className="flex gap-6 lg:justify-end text-sm">
                                {[
                                    { name: 'LinkedIn', url: 'https://www.linkedin.com/company/profitpathgrowth' },
                                ].map((social) => (
                                    <a
                                        key={social.name}
                                        href={social.url}
                ...
                <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6 text-[10px] uppercase tracking-[0.2em] text-zinc-500 font-bold">
                    <div className="flex gap-8">
                        <p onClick={() => { navigate('/terms-and-conditions'); window.scrollTo(0, 0); }} className="hover:text-white transition-colors cursor-pointer">Terms & Conditions</p>
