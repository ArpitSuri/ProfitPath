...
const Footer = () => {
    ...
    return (
        <footer className="text-white pt-16 md:pt-24 pb-12 px-6 md:px-10 border-t border-white/5 bg-black">
            <div className="max-w-7xl mx-auto">

                {/* --- TOP SECTION: Newsletter --- */}
                {/* <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-10 pb-16 border-b border-white/5 mb-16">
                    <div className="max-w-md">
                        <h3 className="text-2xl md:text-3xl font-bold tracking-wider mb-2">Subscribe to the Path</h3>
                        <p className="text-zinc-500 font-light text-sm md:text-base">
                            Get the latest marketing insights and case studies delivered to your inbox.
                        </p>
                    </div>
                    <div className="flex flex-col sm:flex-row w-full lg:w-auto gap-3 md:gap-4">
                        <input
                            ...
                            className="bg-white/5 border border-white/10 rounded-full px-6 py-4 w-full lg:w-80 focus:outline-none focus:border-white/30 transition-colors text-sm"
                        />
                        <button className="bg-white text-black px-8 py-4 rounded-full font-bold uppercase text-[10px] md:text-xs hover:bg-zinc-200 transition-all whitespace-nowrap active:scale-95">
                            Join Now
                        </button>
                    </div>
                </div> */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-16 mb-20">
                    ...
                    {/* Brand & Description */}
                    <div className="lg:col-span-5 flex flex-col items-start gap-6 md:gap-8">
                        <div className="flex items-center gap-6">
                            <img
                                src={logo}
                                alt="ProfitPath"
                                className="h-10 md:h-15 w-auto object-contain cursor-pointer"
                                onClick={() => handleNavigation('/')}
                            />
                           
                        </div>

                        <p className="text-zinc-500 max-w-sm font-light leading-relaxed text-xl">
                            ProfitPath Growth Partners is a DC-based sales prospecting agency. We put sales prospecting and capital raising on <span className="text-zinc-300">auto-pilot</span> through fully-managed services, delivering opportunities with industry leaders.
                        </p>

                        {/* Trust Badges */}
                        <div className="flex items-center gap-8 pt-2">
                            <a href="https://www.goodfirms.co/company/profitpath-growth-partners" target="_blank" rel="noopener noreferrer" className="opacity-60 hover:opacity-100 transition-opacity">
                                <svg xmlns="http://www.w3.org/2000/svg" width="130" height="40" fill="none" viewBox="0 0 160 31" className="brightness-0 invert">
                            ...
                            <a href="https://clutch.co/profile/profitpath-growth-partners" target="_blank" rel="noopener noreferrer" className="opacity-60 hover:opacity-100 transition-opacity">
                                <img src="/clutch.svg" alt="Clutch" className="h-5 w-auto brightness-0 invert" />
                            </a>
                            <a href="https://clutch.co/profile/profitpath-growth-partners" target="_blank" rel="noopener noreferrer" className="opacity-60 hover:opacity-100 transition-opacity">
                                <img src="https://cdn.trustpilot.net/brand-assets/4.3.0/logo-white.svg" alt="Clutch" className="h-7 w-auto brightness-0 invert" />
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-3 flex flex-col gap-6">
                        <h4 className="text-[14px] uppercase tracking-[0.2em] text-zinc-500 font-bold">Navigation</h4>
                    ...
                    <div className="lg:col-span-4 flex flex-col gap-8 lg:items-end lg:text-right">
                        <div>
                            <h4 className="text-[14px] uppercase tracking-[0.2em] text-zinc-500 font-bold mb-4">Contact</h4>
                            <p className="text-white font-medium mb-1 text-lg">sales@profitpathgrowthpartners.com</p>
                        ...
                        <div>
                            <div className="flex gap-6 lg:justify-end">
                                <a
                                    ...
                                    className="text-zinc-400 hover:text-white transition-all duration-300 uppercase tracking-widest text-[10px] hover:-translate-y-1"
                                >
                                    LinkedIn
                                </a>
                            </div>
                ...
                <div className="pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6 text-[9px] md:text-[10px] uppercase tracking-[0.2em] text-zinc-500 font-bold text-center md:text-left">
                    <div className="flex gap-6 md:gap-8">
                        <p onClick={() => handleNavigation('/terms-and-conditions')} className="hover:text-white transition-colors cursor-pointer">Terms & Conditions</p>
