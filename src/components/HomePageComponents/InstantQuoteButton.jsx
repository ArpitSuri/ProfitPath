...
const InstantQuoteButton = () => {
    ...
    return (
        <button
            ...
            className="group px-6 py-2 border border-zinc-500/50 text-white text-sm cursor-pointer font-black tracking-widest rounded-full hover:bg-white hover:text-black transition-all flex items-center gap-3 bg-transparent"
        >
