            ...
            <div className="w-full max-w-7xl flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-8">
                ...
                >
                    <div className="relative group">
                        ...
                        {/* The Main Circle */}
                        <div className="relative z-10 w-64 h-64 md:w-80 md:h-80 rounded-full border border-white/10 bg-zinc-950  items-center justify-center p-8 overflow-hidden hidden lg:flex">
